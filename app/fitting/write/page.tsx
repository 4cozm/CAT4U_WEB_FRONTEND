...
export default function FittingWritePage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl">피팅 공유</CardTitle>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              {!isPreview ? (
                <Textarea
                  ...
                  placeholder="피팅에 대한 설명을 마크다운 형식으로 작성하세요..."
            ...
            <div className="space-y-4">
              ...
              {clipboards.map((clipboard, index) => (
                <Card key={clipboard.id} className="p-4">
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <Label className="text-sm font-medium">피팅 {index + 1}</Label>
                      <Button
                        type="button"
                        variant="ghost"
                        size="sm"
                    ...
                    <Input
                      placeholder="피팅 이름 (예: Rifter - 근접 전투형)"
              ...
              {clipboards.length === 0 && (
                <div className="text-center py-8 text-gray-500">
                  <p>피팅 정보가 없습니다.</p>
                  <p className="text-sm">함선 피팅을 공유하려면 피팅을 추가하세요.</p>
                </div>
              )}
            </div>
            ...
            <div className="bg-blue-50 p-4 rounded-lg">
              <h4 className="font-medium mb-2">피팅 공유 가이드</h4>
              <div className="text-sm text-gray-600 space-y-1">
                <p>• 피팅의 용도와 특징을 명확히 설명하세요</p>
                <p>• EVE 게임 내에서 피팅을 복사하여 붙여넣으세요</p>
                <p>• 사용법과 주의사항을 포함하세요</p>
